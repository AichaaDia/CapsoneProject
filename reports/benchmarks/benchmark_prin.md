...
**Date d'exécution :** 2026-02-02 18:15:59

## 1️⃣ Avant optimisation — Format Parquet

- Durée d'exécution : 0.59 secondes
...
- Durée d'exécution : 0.38 secondes
...
|------------|-----------------|---------------|--------------|
| Durée (s) | 0.59 | 0.38 | La lecture a été accélérée grâce à la structure optimisée et à la gestion des transactions. |
