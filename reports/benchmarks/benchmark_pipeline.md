...
**Date d'exécution :** 2026-02-02 18:03:58

## 1️⃣ Avant optimisation — Format Parquet

- Durée d'exécution : 0.57 secondes
...
- Durée d'exécution : 0.26 secondes
...
|------------|-----------------|---------------|--------------|
| Durée (s) | 0.57 | 0.26 | La lecture a été accélérée grâce à la structure optimisée et à la gestion des transactions. |
...
Dans l'ensemble, l'optimisation vers Delta Lake apporte des améliorations en termes de performances et de gestion des fichiers. Nous recommandons de continuer à monitorer la taille des fichiers et la durée d'exécution pour s'assurer que le pipeline reste performant. Cette synthèse fournit une vue claire des gains obtenus et des points à surveiller pour les prochaines étapes.
